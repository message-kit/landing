import { AtSignIcon, ChevronRightIcon, MailIcon, Wifi, Zap } from "lucide-react";
            ...
            <div className="container">
                <div className="flex flex-col gap-5">
                    ...
                    <Image
                        src="/hero.png"
                        alt={imageAlt}
                        className="mx-auto h-full shadow-2xl max-h-[524px] w-full max-w-4xl rounded-2xl object-cover border-8 border-primary"
                        width={3840}
                        height={2400}
                    />
                </div>
